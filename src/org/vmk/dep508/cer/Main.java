...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(usdMoney.divide(new BigDecimal("0.55")).getAmount());
        System.out.println(usdMoney.divide(new BigDecimal("0.5102")).getAmount());
        System.out.println(usdMoney.multiply(new BigDecimal("0.55123")).getAmount());
        System.out.println(usdMoney.multiply(new BigDecimal("0.4912")).getAmount());
